...
controller.player3.onButtonEvent(ControllerButton.Right, ControllerButtonEvent.Pressed, function () {
    mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Three)).setImage(img`
        ...
        . 1 1 1 f f f 2 2 f f f 1 1 1 . 
        1 1 1 f f f 2 2 2 2 f f f 1 1 1 
        1 1 f f f e e e e e e f f f 1 1 
        1 1 f f e 2 2 2 2 2 2 e e f 1 1 
        1 1 f e 2 f f f f f f 2 e f 1 1 
        1 1 f f f f e e e e f f f f 1 1 
        1 f f e f b f 4 4 f b f e f f 1 
        1 f e e 4 1 f d d f 1 4 e e f 1 
        1 1 f e e d d d d d d e e f 1 1 
        . 1 1 f e e 4 4 4 4 e e f 1 1 . 
        . . e 4 f 2 2 2 2 2 2 f 4 e 8 . 
        . . 4 d f 2 2 2 2 2 2 f d 4 8 8 
        . . 4 4 f 4 4 5 5 4 4 f 4 4 f . 
        . . . . . f f f f f f . . . . . 
        . . . . . f f . . f f . . . . . 
        `)
...
scene.setBackgroundImage(img`
    ...
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    `)
mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).setPosition(160, 60)
mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).setPosition(0, 60)
...
mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Three)).setPosition(70, 8)
